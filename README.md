...
`poll.yml` runs about every **5 minutes** during NFL windows: Sunday all day UTC; TNF evening-only in America/Denver (`*/5 23 * * 4` and `*/5 0-5 * * 5`, about 5:00 PM–11:59 PM MT); and Mon/Tue overnight for leftover SNF / MNF. If the scoreboard has no in-progress or recently finished game, it exits after the scoreboard call.
